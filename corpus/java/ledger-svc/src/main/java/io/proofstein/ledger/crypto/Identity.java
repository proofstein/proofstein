...
public final class Identity {
    ...
    public static Identity generate() throws GeneralSecurityException {
        KeyPairGenerator blocks = KeyPairGenerator.getInstance("Ed25519");
        KeyPairGenerator peers = KeyPairGenerator.getInstance("EC");
        peers.initialize(new ECGenParameterSpec("secp256r1"));

        KeyPairGenerator settlement = KeyPairGenerator.getInstance("RSA");
