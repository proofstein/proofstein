...
require golang.org/x/crypto v0.36.0 //@PS go-dep-xcrypto|golang.org/x/crypto|5|algorithm|declared crypto dependency (provides Curve25519, NaCl, HKDF); never imported by the default build
