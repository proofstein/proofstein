...
public final class BlockSeal {
    ...
    public static KeyPair lattice() throws GeneralSecurityException {
        KeyPairGenerator generator = KeyPairGenerator.getInstance("ML-DSA", "BC"); //@PS java-l1-mldsa|ML-DSA|1|algorithm|Bouncy Castle ML-DSA via KeyPairGenerator.getInstance("ML-DSA", "BC")
    ...
    public static KeyPair hashBased() throws GeneralSecurityException {
        KeyPairGenerator generator = getInstance("SLH-DSA", "BC"); //@PS java-l2-slhdsa|SLH-DSA|2|algorithm|SLH-DSA reached through a static import of KeyPairGenerator.getInstance
    ...
    public static KeyPair compact() throws GeneralSecurityException {
        ...
        generator.initialize(FalconParameterSpec.falcon_512); //@PS java-l1-falcon|Falcon-512|1|algorithm|Bouncy Castle FalconParameterSpec.falcon_512
        return generator.generateKeyPair();
    }
}
