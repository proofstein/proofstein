...
import { ml_dsa65 } from "@noble/post-quantum/ml-dsa"; //@PS js-l1-mldsa|ML-DSA-65|1|algorithm|@noble/post-quantum ml_dsa65 signing key
...
export function signHashBased(secretKey: Uint8Array, payload: Uint8Array): SignedAssertion {
  const signature = slh_dsa_sha2_128f.sign(secretKey, payload); //@PS js-l2-slhdsa|SLH-DSA|2|algorithm|SLH-DSA sha2_128f reached through a named import of @noble/post-quantum/slh-dsa
