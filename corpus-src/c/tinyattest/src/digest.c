...
#define ta_md_sha256 EVP_sha256 /*@PS +c-l2-sha256 */
...
int ta_report_digest(const unsigned char *report, size_t report_len, unsigned char *out)
{
	...
	if (EVP_DigestInit_ex(ctx, ta_md_sha256(), NULL) != 1) /*@PS c-l2-sha256|SHA-256|2|algorithm|aliased API: EVP_sha256 reached through the ta_md_sha256 macro */
		goto out;
