...
#define TA_RECORD_SEAL_PARAMS "XMSS-SHA2_10_256" /*@PS c-l1-xmss|XMSS|1|algorithm|XMSS-SHA2_10_256 parameter set passed to wolfSSL wc_XmssKey_SetParamStr*/
...
int ta_seal_firmware_keygen(unsigned char *public_key, size_t *public_key_len)
{
	...
	if (wc_LmsKey_SetLmsParm(&key, WC_LMS_PARM_L2_H10_W8) != 0) /*@PS c-l1-lms|LMS|1|algorithm|wolfSSL wc_LmsKey_SetLmsParm selecting the two-level H10/W8 parameter set*/
		goto out_key;
